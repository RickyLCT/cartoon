...
def train(args):
    ...
    with tf.device('/device:GPU:0'):
        ...
        face_cartoon_dir = os.fspath(os.path.join(os.fspath('../dataset/face_cartoon/kyoto_face'), os.fspath('../pa_face')))
        face_cartoon_list = utils.load_image_list(face_cartoon_dir)
        #scenery_cartoon_dir = '../dataset/scenery_cartoon'
        scenery_cartoon_dir = os.fspath(os.path.join(os.fspath('../dataset/scenery_cartoon/hayao'), os.fspath('../hosoda'), os.fspath('../shinkai')))
